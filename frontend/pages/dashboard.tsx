          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              <div className="flex-shrink-0 flex items-center">
                <h1 className="text-xl font-bold text-indigo-600">MediFlow Lite</h1>
              </div>
              <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                ...
                <a href="/patients" className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                  Patients
                </a>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <p className="text-gray-600">
                Healthcare Automation System - Dashboard
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-500 truncate">Register a new patient</p>
              </div>
            </a>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-500 truncate">Book a new appointment</p>
              </div>
            </a>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-500 truncate">Browse patient records</p>
              </div>
            </a>
          </div>
        </div>
